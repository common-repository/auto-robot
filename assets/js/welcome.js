    ...
    var AutoRobotWelcome = {
         ...
         */
         _triggerCampaign: function( ) {
            ...
            if (type == 'rss') {
                ...
                window.location.replace(Auto_Robot_Data.pricing_url);
            }
        ...
        _nextSlider: function( event ) {
           ...
           if ( currentSlider.hasClass('robot-slide-campaign-name') && $( "input[name='robot_campaign_name']" ).val().length == 0 ){
                console.log('prevent slider animate');
                $('.robot-error-message-name').css("display", "block");
                return;
           }else if(currentSlider.hasClass('robot-generate-slide') && $( "input[name='rss_selected_keywords']" ).val().length == 0){
                console.log('prevent slider animate');
            ...
            if ( currentSlider.next('.robot-slide').hasClass('robot-generate-slide') ){
                $('.robot-welcome-next').addClass('robot-generate-campaign');
            }
        },
