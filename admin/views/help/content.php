...
<div class="wrap about-wrap">
	...
	<div class="about-text">
		<p>
			...
			<a href="https://wpautorobot.com/pricing">
    		<button class="robot-button robot-button-blue">
            	<?php esc_html_e( 'Get Auto Robot Pro Version Here', Auto_Robot::DOMAIN ); ?>
        	</button>
    		</a>
	</div>
	...
	<div id="help" class="active nav-container">
		<div class="changelog section-getting-started">
			<div class="feature-section">
				...
				<img src="<?php echo esc_url('http://robot.wphobby.com/wp-content/uploads/2020/10/auto-robot-new-campaign.png') ?>" class="robot-help-screenshot" alt="<?php esc_attr_e( 'Auto Robot', Auto_Robot::DOMAIN ); ?>">
		...
		<div class="changelog section-getting-started">
			<div class="feature-section">
				...
				<img src="<?php echo esc_url('http://robot.wphobby.com/wp-content/uploads/2020/10/auto-robot-campaigns-list.png') ?>" class="robot-help-screenshot" alt="<?php esc_attr_e( 'Auto Robot', Auto_Robot::DOMAIN ); ?>">
