...
if ( ! class_exists( 'Auto_Robot_Custom_Form' ) ) :

class Auto_Robot_Custom_Form extends Auto_Robot_Module {
	...
	public function load_admin() {
		if( is_admin() ) {
			...
			new Auto_Robot_Custom_Form_Admin();
		}
	}
	...
	public function register_cpt() {
		...
		register_post_type( 'auto_robot_forms', $args );
	}
	...
	public function options() {
		return array(
			'name'          => __('Custom Forms', Auto_Robot::DOMAIN),
			'singular_name' => __('Custom Form', Auto_Robot::DOMAIN),
			'description'   => __( "Custom forms, conditional forms, etc. Choose from our library of forms or create a new one from scratch.", Auto_Robot::DOMAIN ),
			'button_label'  => __( "New Custom Form", Auto_Robot::DOMAIN ),
